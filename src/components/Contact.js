...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Webhook (n8n) may return different shape; treat 2xx as success unless body says otherwise
      ...
      // Fallback: send email via Nodemailer so you still get the notification
      try {
